...
- [svelte](./.agents/svelte/SKILL.md): create and edit Svelte 5 and SvelteKit code with concise patterns for runes, reactivity, bindings, attachments, and class-first state
